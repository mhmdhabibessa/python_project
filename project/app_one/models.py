...
from app_tow.models import User
...
class Sugestion(models.Model):
    ...
    ubdatedBy=models.ForeignKey(User, related_name="sugestied", null=True, on_delete= models.CASCADE)
...
class Session(models.Model):
    ...
    bookedBy=models.ForeignKey(User, related_name="booked", null=True, on_delete= models.CASCADE)
    bookedWith=models.ForeignKey(User, related_name="bookedAt", null=True, on_delete= models.CASCADE)
    createdAt = models.DateTimeField(auto_now_add=True)
    updatedAt = models.DateTimeField(auto_now=True)
...
class dayTimeSlot(models.Model):
    ...
    startAt,endAt: start and end time of the slot
    """
